...
user_number = int(input('Enter the account number of a prime number: '))
print(sieve_without_eratosthenes(user_number))

print('Algorithm 1 without using the "Sieve of Eratosthenes" algorithm')
print(
    f'{sieve_without_eratosthenes(user_number)} - {user_number} \
prime number'
)

print('Algorithm 2 using the "Sieve of Eratosthenes" algorithm')
print(
    f'{sieve_eratosthenes(user_number)} - {user_number} prime number'
)
